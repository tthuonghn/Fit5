 ...
 */
public class TargetCalListViewAdapter extends BaseAdapter {
    Context context;
    Bundle bundleData;
    String [] titleList;
    int [] imageId;
    ...
    TargetCalObjectManager objManager;
    public TargetCalListViewAdapter(Context context, Bundle bundleInput) {
